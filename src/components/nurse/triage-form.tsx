...
import { Patient, Sentiments } from '@/utils/nurse/nurseTypes'
...
export function TriageForm({
  ...
  const [aiEvaluation, setAiEvaluation] = useState<TriageEvaluation | null>(null);
  ...
  const handleSubmit = () => {
    ...
    const patientData: Patient = {
      ...
      priority: 'P' + String(finalPriority) || (aiEvaluation ? String(aiEvaluation.priority) : ''),
      NOK: formData.emergencyContact,
  ...
  return (
    <div className='flex flex-col h-full'>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <div>
                      {formData.vitals.temperature && (
                        ...
                        >
                          {Number.parseFloat(formData.vitals.temperature) >= 38.5
                            ? 'High Fever'
                            : Number.parseFloat(formData.vitals.temperature) >=
                              37.6
                            ? 'Fever'
      ...
      {/* Floating button */}
      <div
        className={`sticky z-50 bottom-6 left-1/2 w-0 translate-x-1/2 transition-all duration-300`}
      >
        <Button
          // onClick={() => setShowAIChat(!showAIChat)}
          className='opacity-50 hover:opacity-100 w-14 h-14 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-200'
        >
